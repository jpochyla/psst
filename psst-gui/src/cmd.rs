...
pub const QUIT_APP_CLEAN: Selector = Selector::new("app.quit-clean");
pub const TRAY_REMOVED: Selector = Selector::new("app.tray-removed");
...
pub const PLAY_PAUSE_TOGGLE: Selector = Selector::new("app.play-pause-toggle");
